                ...
                <div className="py-5 px-[50px] flex items-center justify-between ">
                    <a href="/" className="cursor-pointer inline-block">
                        {theme == 'light' ? (
                            ...
                            <img className="w-[300px]" src="https://thanglong.edu.vn/themes/md_tlu_2/img/logo.svg" />
                ...
                <div className="container text-center flex flex-col items-center max-w-[1024px] pt-[100px]">
                    <div className="max-w-[800px]">
                            ...
                            {showTyped && (
                                <Typed
                                    strings={[
                                        ...
                                        'Một bài tập lớn của môn Dự án Công nghệ thông tin',
                                    ]}
                                    typeSpeed={60}
                                    backSpeed={40}
                                    backDelay={1500}
                        ...
                        <p className="leading-[1.875] mb-7 px-[10px]">
                            Ứng dụng được phát triển và xây dựng cho bộ môn Dự án công nghệ thông tin. Mọi thắc mắc xin liên hệ với trưởng nhóm để được hướng dẫn và giải
                            quyết!{' '}
                        </p>
                        <a href="/login">
                            <Button
